...
describe("local persistence adapter", () => {
  ...
  it("updateOrderStatus no pisa un pedido que otra persona ya movi�", async () => {
    const adapter = createLocalPersistenceAdapter();
  ...
  it("updateOrderPaymentStatus no pisa un pago que otra persona ya cambi�", async () => {
    const adapter = createLocalPersistenceAdapter();
  ...
  it("updateProduct guarda solo los cambios si la versi�n coincide y avanza la versi�n", async () => {
    const adapter = createLocalPersistenceAdapter();
  ...
  it("updateProduct no escribe si otra persona cambi� el producto", async () => {
    const adapter = createLocalPersistenceAdapter();
