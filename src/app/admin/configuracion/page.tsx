...
export default function AdminSettingsPage() {
  ...
  const isPaymentEnabled = process.env.NEXT_PUBLIC_MERCADO_PAGO_ENABLED === "true";
  const integrations = [
